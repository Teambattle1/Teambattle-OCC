...
const AFGANG_ITEMS: PackingItem[] = [
  { id: 'a1', text: 'BOX med kasser med Lego droner' },
  { id: 'a2', text: 'Husk kasse med ekstra legoklodser "FLYBRIX EXTRA"', indent: true },
  { id: 'a3', text: 'Tablets med "FlyBrix" app (Orange F ikon)' },
  { id: 'a4', text: 'Kasse med de hvide droner' },
  { id: 'a5', text: 'Kasse med controllere til hvide droner' },
  { id: 'a6', text: '2 kasser med RC biler (8 stk.)' },
  { id: 'a7', text: '1 kasse med RC GEAR + kegler' },
  { id: 'a8', text: 'Batterier til gear (VIGTIGT!)' },
  { id: 'a9', text: 'Batterier til Lego droner (med velcro)', indent: true },
  { id: 'a10', text: 'Batterier til droner (uden velcro)', indent: true },
  { id: 'a11', text: 'Batterier til controllere (AA)', indent: true },
  { id: 'a12', text: 'Batterier til RC biler (specielle)', indent: true },
  { id: 'a13', text: 'Orange helipad ring (i GEARBOX til droner)' },
  { id: 'a14', text: 'JBL Extreme 5 Højtaler' },
];

const HJEMKOMST_ITEMS: PackingItem[] = [
  { id: 'h1', text: 'Gearet skal virke og være klar til næste bruger' },
  { id: 'h2', text: 'Alle batterier skal oplades' },
  { id: 'h3', text: 'Tjek at de små DRONE batterier lader', indent: true },
  { id: 'h4', text: 'Tjek at Controller batterier til RC biler lader', indent: true },
  { id: 'h5', text: 'Tjek at RC batterier til biler lader', indent: true },
  { id: 'h6', text: 'Alle brugte/tændte tablets til opladning' },
...
const TeamControlPackingList: React.FC<PackingListProps> = ({ mode }) => {
  const items = mode === 'afgang' ? AFGANG_ITEMS : HJEMKOMST_ITEMS;
  const storageKey = `teamcontrol_packing_${mode}`;
        ...
        <div className="flex items-center justify-between mb-4 tablet:mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] tablet:text-xs text-gray-500 uppercase">TeamControl</p>
            </div>
          </div>
...
export default TeamControlPackingList;
